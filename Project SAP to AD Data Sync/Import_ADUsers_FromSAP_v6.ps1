# Takes 2 parameters. 1 Folder Path and 2. CSV file name.
...
Send-MailMessage @smtpsettings -Body "SAP AD Sync Log Attached....." -BodyAsHtml -Encoding ([System.Text.Encoding]::UTF8) -Attachments $logfile
